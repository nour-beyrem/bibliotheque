...
public class Etudiant extends javax.swing.JFrame {
  ResultSet rs;
    ...
    public Etudiant() {
     ...
     public void table() {
       String a[] = {"idE","nom","prenom","sexe", "adresse","telephone","email","classe"};
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(classe, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(rech, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(28, 28, 28)
    ...
    private void suppActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_suppActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(this, "est ce que tu es sure que tu veux suuprimer", "attention!!!", 
            ...
            db.queryDelete("etudiant", "idE='" + id+"'");
        } else {
            return;
        }
        table();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
            if ( nom.getText().equals("") || prenom.getText().equals("") || sexe.getText().equals("") || adresse.getText().equals("") || telephone.getText().equals("")|| email.getText().equals("")|| classe.getText().equals("") ) {
            JOptionPane.showMessageDialog(this, "SVP entrer les informations complete");
        } else {
            String[] colon = {"nom","prenom",  "sexe", "adresse","telephone","email","classe"};
            String[] inf = { nom.getText(), prenom.getText(),sexe.getText(), adresse.getText(), telephone.getText(), email.getText(), classe.getText()};
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
        // TODO add your handling code here:
         if (id.getText().equals("") || nom.getText().equals("") || prenom.getText().equals("") || sexe.getText().equals("") || adresse.getText().equals("") || telephone.getText().equals("")|| email.getText().equals("")|| classe.getText().equals("")
                ) {
            JOptionPane.showMessageDialog(this, "SVP entrer les informations complete");
        } else {
          String[] colon = {"idE","nom","prenom",  "sexe", "adresse","telephone","email","classe"};
          String[] inf = {id.getText(), nom.getText(), prenom.getText(),sexe.getText(), adresse.getText(), telephone.getText(), email.getText(), classe.getText()};
           
           // String id = String.valueOf(tbl_use.getValueAt(tbl_user.getSelectedRow(), 0));
            System.out.println(db.queryUpdate("etudiant", colon, inf, "idE='" + id.getText() + "'"));
            table();
            actualiser();
        }
    ...
    private void tableetudiantMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableetudiantMouseClicked
        ...
        nom.setText((String) tableetudiant.getValueAt(tableetudiant.getSelectedRow(),1));
        
        prenom.setText((String) tableetudiant.getValueAt(tableetudiant.getSelectedRow(),2));
        sexe.setText((String) tableetudiant.getValueAt(tableetudiant.getSelectedRow(),3));
        adresse.setText((String) tableetudiant.getValueAt(tableetudiant.getSelectedRow(),4));
        Long i= (Long) tableetudiant.getValueAt(tableetudiant.getSelectedRow(),5);
        String S= Long.toString(i);
        telephone.setText(S);
        email.setText((String) tableetudiant.getValueAt(tableetudiant.getSelectedRow(),6));
        classe.setText((String) tableetudiant.getValueAt(tableetudiant.getSelectedRow(),7));
        ...
        // TODO add your handling code here:
          if (rech.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "SVP entrer quelque chose");
                ...
                rs = db.querySelectAll("etudiant", "idE LIKE '%" + rech.getText() + "%' ");
                tableetudiant.setModel(new ResultSetTableModel(rs));
